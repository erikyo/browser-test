...
import {roundToDecimals, roundToTwoDecimals} from "../utils";
...
const SecurityTestV2 = () => {
    ...
    return (
      ...
      <section>
          <div
              className="mx-auto max-w-screen-xl pt-8 px-4 flex"
          >
              <div className="max-w-7xl text-center flex flex-col justify-center align-middle">
