...
function Recap() {
    ...
    return (
        <div
            id={'recap'}
            className="grid max-w-7xl lg:max-w-7xl grid-cols-1 mb-8 mt-12 text-center gap-y-8 sm:gap-x-8 sm:grid-cols-2 lg:grid-cols-3  lg:mt-20 sm:text-left justify-between align-last-row">
